...
const Stat = ({ value, label }: { value: string; label: string }) =>
  e(
    "div",
    { style: { textAlign: "center" as const, flex: 1 } },
    e(
      "div",
      {
        style: {
      ...
      e(
        ...
        e(
          ...
          e(
            ...
            "resend",
            e("span", { style: { color: "#3b82f6" } }, "-clone"),
          ),
          e(
            "div",
            { style: { fontSize: "13px", color: "#52525b", marginTop: "8px" } },
            "Autonomous Product Cloner",
          ),
        ),
        ...
        e(
          ...
          e(
            "div",
            { style: { display: "flex", gap: "16px", margin: "0 0 32px" } },
            ...
            ...[
              {
                ...
                desc: "AWS SES production mode with DKIM, SPF, DMARC",
              },
              {
                icon: "🌐",
                title: "Auto DNS Configuration",
                desc: "Cloudflare API auto-configures domain records",
              },
              {
                icon: "⚛️",
                title: "React Email SDK",
                desc: "renderToStaticMarkup() — write emails as components",
              },
              {
                icon: "🔑",
                title: "Full REST API",
                desc: "16+ endpoints with Bearer token auth",
              },
              {
                icon: "🚀",
                title: "Deployed to AWS",
                desc: "App Runner + RDS Postgres + S3",
              },
            ].map((f) =>
              e(
                "div",
